#include "bignum.hpp"
#include "coprime_error.hpp"
#include <memory>

namespace arithmatic {
bignum::bignum(size_t value, bool sign) : value_(value), sign_(sign) {}

bignum::bignum(bits_value &&value, bool sign)
...
bignum bignum::mod_inverse_of(const bignum &mod) const {
  ...
  */
  auto t = std::make_pair<bignum, bignum>(0x00, 0x01U);
